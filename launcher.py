"""
Launcher for Thousand Hills Vacations Show Schedule Creator
This version automatically opens the browser when the app starts
"""
...
if __name__ == '__main__':
    ...
    print("If not, open: http://127.0.0.1:5000")
    ...
    # Run the app (suppress Flask's startup messages in production)
